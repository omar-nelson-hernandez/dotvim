...
let colors_name = "cyber-outrun-neon"

if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi ColorColumn ctermbg=9 ctermfg=233 cterm=NONE guibg=#190d54 guifg=NONE gui=NONE
    ...
    hi CursorLine ctermbg=201 ctermfg=233 cterm=NONE guibg=#110840 guifg=NONE gui=NONE
    ...
    hi Identifier ctermbg=NONE ctermfg=13 cterm=bold guibg=NONE guifg=#fc42f5 gui=NONE
    ...
    hi NonText ctermbg=NONE ctermfg=201 cterm=NONE guibg=NONE guifg=#440091 gui=NONE
    hi Normal ctermbg=233 ctermfg=44 cterm=NONE guibg=#000b1e guifg=#0abdc6 gui=NONE

    set background=dark

    hi Operator ctermbg=NONE ctermfg=201 cterm=bold guibg=NONE guifg=#00ff00 gui=bold
    ...
    hi PreProc ctermbg=NONE ctermfg=13 cterm=bold guibg=NONE guifg=#00ff00 gui=bold
    ...
    hi SignColumn ctermbg=10 ctermfg=233 cterm=NONE guibg=NONE guifg=#000b1e gui=NONE
    hi Special ctermbg=NONE ctermfg=13 cterm=NONE guibg=NONE guifg=#f50e76 gui=bold
    hi SpecialKey ctermbg=NONE ctermfg=green cterm=NONE guibg=NONE guifg=green gui=NONE
    hi SpellBad ctermbg=9 ctermfg=233 cterm=NONE guibg=NONE guifg=#ff0000 gui=BOLD
    ...
    hi String ctermbg=NONE ctermfg=208 cterm=NONE guibg=NONE guifg=#ffa600 gui=NONE
    ...
    hi htmlTagName ctermbg=NONE ctermfg=13 cterm=bold guibg=NONE guifg=#f50e76 gui=bold
